...
binds =
  ...
  , ("M-<Tab>", nextWS)
  , ("M-S-<Tab>", prevWS)
  , ("M-<Print>", spawn "scrot \"$(xdg-user-dir PICTURES)/%Y-%m-%d_%H-%M-%S-scrot.png\"")
  , ("<Print>", spawn "scrot -s \"$(xdg-user-dir PICTURES)/%Y-%m-%d_%H-%M-%S-scrot.png\"")
  ...
  , ("M-b", spawn "clipmenu")
  , ("M-S-q", spawn "kitty nvim /etc/nixos")
  ]
